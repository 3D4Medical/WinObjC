...
static void testPreferencesStringToCString(const char* cBuffer, CFStringEncoding encoding) {
    CFStringRef expectedString = CFStringCreateWithCString(kCFAllocatorSystemDefault, cBuffer, encoding);
